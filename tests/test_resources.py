...
class TestAddressResource:
    ...
    async def test_returns_valid_json(self):
        from src.resources.address import _address_snapshot
    ...
    async def test_registered_as_template_resource(self):
        from src.resources.address import register
...
class TestEntityResource:
    ...
    @pytest.mark.asyncio
    async def test_returns_valid_json(self):
        from src.resources.entity import _entity_profile
    ...
    @pytest.mark.asyncio
    async def test_registered_as_template_resource(self):
        from src.resources.entity import register
        from fastmcp import FastMCP
...
class TestNetworkResources:
    ...
    async def test_network_history_returns_json(self):
        from src.resources.network import _network_history
    ...
    async def test_networks_status_returns_json(self):
        from src.resources.network import _networks_status
    ...
    async def test_registered_as_static_resource(self):
        from src.resources.network import register
        from fastmcp import FastMCP
